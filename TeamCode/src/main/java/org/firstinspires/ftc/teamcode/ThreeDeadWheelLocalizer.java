...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2452.978930134199; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2678.431707656178; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2574.6699542108245; // x position of the perpendicular encoder (in tick units)
    }

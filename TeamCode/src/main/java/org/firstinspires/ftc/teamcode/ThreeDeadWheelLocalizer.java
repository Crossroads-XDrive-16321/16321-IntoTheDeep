...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2524.2508773802697f; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2651.538490498925f; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2368.380239176187; // x position of the perpendicular encoder (in tick units)
    }
